...
export type CodeLine = {
  n: number
  tokens: CodeToken[]
  /** algorithmic "pivot" lines the mentor can spotlight */
  lighthouse?: boolean
}
...
export const problem = {
  ...
  examples: [
    {
      ...
      output: "[0,1]",
      explanation:
        "There are a total of 2 courses. To take course 1 you should have finished course 0. So the correct order is [0,1].",
    },
    {
      input: "numCourses = 4, prerequisites = [[1,0],[2,0],[3,1],[3,2]]",
      output: "[0,2,1,3]",
      explanation:
        "Both [0,1,2,3] and [0,2,1,3] are valid orderings. A topological sort yields one such ordering.",
    },
    {
  ...
  hints: [
    "Think of this as a directed graph where an edge b → a means you must take b before a.",
    "A valid ordering exists if and only if the graph is a DAG.",
    "Kahn's algorithm (BFS on in-degrees) gives you the topological order in O(V + E).",
  ],
}
...
export const codeLines: CodeLine[] = [
  {
    ...
    tokens: [
      { t: "function ", c: "syn-kw" },
      { t: "findOrder", c: "syn-fn" },
      { t: "(", c: "syn-pun" },
      { t: "numCourses", c: "syn-var" },
      { t: ": ", c: "syn-pun" },
      { t: "number", c: "syn-typ" },
      { t: ", ", c: "syn-pun" },
      { t: "prerequisites", c: "syn-var" },
      { t: ": ", c: "syn-pun" },
      { t: "number[][]", c: "syn-typ" },
      { t: ")", c: "syn-pun" },
      { t: ": ", c: "syn-pun" },
  ...
  { n: 4, tokens: [{ t: "", c: "syn-pun" }] },
  {
    n: 5,
    tokens: [
      { t: "  ", c: "syn-pun" },
      { t: "// Build adjacency + in-degree counts", c: "syn-com" },
    ],
  },
  {
    n: 6,
  ...
  { n: 9, tokens: [{ t: "  }", c: "syn-pun" }] },
  { n: 10, tokens: [{ t: "", c: "syn-pun" }] },
  {
    n: 11,
    tokens: [
      { t: "  ", c: "syn-pun" },
  ...
  },
  {
    ...
    tokens: [
      ...
      { t: "i = ", c: "syn-var" },
      { t: "0", c: "syn-num" },
      { t: "; i < numCourses; i++) ", c: "syn-pun" },
      { t: "if ", c: "syn-kw" },
      { t: "(indegree[i] === ", c: "syn-pun" },
      { t: "0", c: "syn-num" },
      { t: ") queue.push(i)", c: "syn-pun" },
    ],
  },
  { n: 13, tokens: [{ t: "", c: "syn-pun" }] },
  {
    n: 14,
    tokens: [
      { t: "  ", c: "syn-pun" },
  ...
  },
  {
    ...
    tokens: [
      ...
      { t: "[u]) ", c: "syn-pun" },
      { t: "if ", c: "syn-kw" },
      { t: "(--indegree[v] === ", c: "syn-pun" },
      { t: "0", c: "syn-num" },
      { t: ") queue.push(v)", c: "syn-pun" },
    ],
    lighthouse: true,
  },
  { n: 19, tokens: [{ t: "  }", c: "syn-pun" }] },
  { n: 20, tokens: [{ t: "", c: "syn-pun" }] },
  {
    n: 21,
    tokens: [
      { t: "  ", c: "syn-pun" },
      { t: "return ", c: "syn-kw" },
      { t: "order.length === numCourses ? order : []", c: "syn-pun" },
    ],
  },
  { n: 22, tokens: [{ t: "}", c: "syn-pun" }] },
]
...
export const mentorSeed: MentorTurn[] = [
  {
    role: "mentor",
