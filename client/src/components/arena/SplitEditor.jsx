...
export function SplitEditor({ language = 'javascript', starterCodeMap = null, onLanguageChange, onEditorRef }) {
  ...
  return <div className="h-full w-full">
    ...
    <PanelGroup direction="horizontal" className="h-full">
      ...
      <PanelResizeHandle className="group relative flex w-2 flex-shrink-0 cursor-col-resize items-center justify-center bg-[#0a0a0a] transition-colors duration-150 hover:bg-[var(--signal)]/20 z-10">
        {/* Visual grip dots */}
