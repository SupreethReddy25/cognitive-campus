...
import { Search, Globe, Flame, Loader2 } from "lucide-react";
          ...
          <div className="flex items-end justify-between">
            <div>
              ...
              <p className="mt-4 max-w-xl font-sans text-[13.5px] leading-relaxed text-zinc-500 text-pretty">
                ...
                <span className="text-zinc-300">{enriched.length}</span> active hackers.
              </p>
            </div>

            {you && <div className="relative min-w-[280px] border border-white/[0.08] p-5">
    ...
    animationDelay: `${Math.min(index * 20, 300)}ms`
      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            <span className={`truncate font-sans text-[14px] font-medium ${row.isYou ? "text-[var(--signal)]" : "text-zinc-100"}`}>
              {row.name}
            </span>
